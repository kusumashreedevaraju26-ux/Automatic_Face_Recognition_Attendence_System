...
def err_screen():
    ...
    sc1.title('Warning!!')
    sc1.configure(background='white smoke')
    Label(sc1, text='Enrollment & Name required!!!', fg='black',
          bg='lavender', font=('times', 16)).pack()
    Button(sc1, text='OK', command=del_sc1, fg="black", bg="SeaGreen1", width=9,
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(
                        text=e, bg="red", fg="black", width=33, font=('times', 16, 'bold'))
                ...
                insert_data = "INSERT INTO " + DB_Table_name + \
                    " (ID,ENROLLMENT,NAME,DATE,TIME) VALUES (%s, %s, %s, %s,%s)"
                ...
                cs = 'C:/Users/kusuma/Projects/Face-Recognition-Attendance-System-main/' + fileName
    ...
    Notifica = tk.Label(windo, text="Attendance filled Successfully", bg="Green", fg="white", width=33,
                        height=2, font=('times', 16, 'bold'))

    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\kusuma\Projects\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')

    attf = tk.Button(windo, text="Check Sheets", command=Attf, fg="grey10", bg="LemonChiffon4",
    ...
    fill_a = tk.Button(windo, text="Fill Attendance", fg="gray15", command=Fillattendances, bg="SkyBlue1", width=20, height=2,
    ...
    def log_in():
        ...
        if username == 'Kusuma':
            if password == 'kusuma12':
                ...
                cs = 'C:/Users/kusuma/Projects/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Face_Recognition_Based_Attendance_Management_System", bg="black", fg="ghost white", width=47,
...
lbl = tk.Label(window, text="Enter Enrollment ID : ", width=20, height=2,
               fg="black", bg="grey", font=('times', 16, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Name : ", width=20, fg="black",
                bg="grey", height=2, font=('times', 16, ' bold '))
...
clearButton = tk.Button(window, text="Clear", command=clear, fg="black", bg="grey",
                        width=10, height=1, activebackground="white", font=('times', 14, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear", command=clear1, fg="black", bg="grey",
                         width=10, height=1, activebackground="white", font=('times', 14, ' bold '))
